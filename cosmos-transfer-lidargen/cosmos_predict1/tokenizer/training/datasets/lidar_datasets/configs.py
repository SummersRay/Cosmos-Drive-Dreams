...
COMMONDATA_CONFIG[f"lidar_range_map_rRow{repeat_row}_train"] = {
    ...
    "max_range": 100,
    "min_range": 5,
    "downsample_factor_row": downsample_factor_row,
    "downsample_factor_col": downsample_factor_col,
    ...
    "RGB_FPS": 30,
    "LIDAR_FPS": 10,
    "load_lidar_and_rgb": False,  # specified as projects/edify_video/v4/config/gen3c/config_gen3c.py
...
COMMONDATA_CONFIG[f"lidar_range_map_rRow{repeat_row}_val"] = deepcopy(
    COMMONDATA_CONFIG[f"lidar_range_map_rRow{repeat_row}_train"]
)
